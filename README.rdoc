...
Salesforce bulk Api is a simple ruby gem for connecting to and using the Salesforce Bulk API. 
...
To initialize:
  ...
  client = Databasedotcom::Client.new :client_id =>  $SFDC_APP_CONFIG["client_id"], :client_secret => $SFDC_APP_CONFIG["client_secret"]
...
You can use username password combo
